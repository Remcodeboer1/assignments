...
cleandf[1:4] <- round(cleandf[1:4], digits = 1) ## Rounding data for better visibility
...
```{r}
cleandf$Occupancy <- factor(cleandf$Occupancy, levels = c("1","0"), labels = c("Occupied", "Unoccupied")) %>% relevel("Unoccupied")
